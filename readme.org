...
- *Persistent context* : agents remember the full conversation, pick up where you left off
- *Parallel agents* : talk to your frontend agent in one channel, backend agent in another
